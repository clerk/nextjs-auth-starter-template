      ...
      <main className="bg-[#FAFAFA] grid-rows-3">
        <div className="w-full bg-white max-w-[1200px] mx-auto flex flex-col border-l border-r border-[#F2F2F2]">
          <div className="px-12 py-16">
            ...
            <div className="absolute left-0 right-0 h-px bg-[#F2F2F2] translate-y-16" />
          </div>

          <div className="p-10 border-b border-[#F2F2F2]">
            <h1 className="text-5xl font-bold tracking-tight text-[#131316]">Auth starts here</h1>
            <p className="text-[#5E5F6E] pt-3 pb-6 max-w-[480px] text-[17px]">
