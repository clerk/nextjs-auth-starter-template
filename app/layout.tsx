    ...
    <html lang="en" className={`${GeistSans.variable}`}>
      ...
      >
        <body className={`min-h-screen flex flex-col antialiased`}>
          {children}
          <footer className="max-w-[1200px] w-full mx-auto pt-7 border-t border-[#EEEEF0] flex justify-between mt-16">
            ...
            <ul className="flex ml-auto gap-2">
              <li>
                <a
                  ...
                  target="_blank"
                  className="flex items-center gap-2 font-medium text-[13px] rounded-full px-3 py-2 hover:bg-gray-100"
                >
                  Clerk Docs{' '}
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
